...
/**
 * Created by mohammadmahdi on 11/23/16.
 */
public class ResponsiveLibraryIndicator extends InkPageIndicator implements ResponsiveView {
    ...
    public ResponsiveLibraryIndicator(Context context) {
        super(context);
    }

    public ResponsiveLibraryIndicator(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public ResponsiveLibraryIndicator(Context context, AttributeSet attrs, int defStyle) {
